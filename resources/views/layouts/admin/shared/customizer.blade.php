 ...
 <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block">
     ...
     <!-- <a id="rtl-icon" href="https://pixinvent.com/apex-angular-4-bootstrap-admin-template/html-demo-6/" target="_blank" class="bg-dark customizer-toggle"><span class="font-medium-1 white align-middle">RTL</span></a> -->
    ...
    <input type="hidden" name="customizer_csrf_token" id="customizer_csrf_token" value="{{ csrf_token() }}" />
    ...
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row sb-bg-img">
          <div class="col-sm-2 mb-3"><img src="{{ getasset('/app-assets/img/sidebar-bg/01.jpg')}}" width="90" class="rounded sb-bg-01 {{ getSession('sidebar-background') == 'app-assets/img/sidebar-bg/01.jpg' ? 'selected' : '' }} "></div>
          <div class="col-sm-2 mb-3"><img src="{{ getasset('/app-assets/img/sidebar-bg/02.jpg')}}" width="90" class="rounded sb-bg-02 {{ getSession('sidebar-background') == 'app-assets/img/sidebar-bg/02.jpg' ? 'selected' : '' }}"></div>
          <div class="col-sm-2 mb-3"><img src="{{ getasset('/app-assets/img/sidebar-bg/03.jpg')}}" width="90" class="rounded sb-bg-03 {{ getSession('sidebar-background') == 'app-assets/img/sidebar-bg/03.jpg' ? 'selected' : '' }}"></div>
          <div class="col-sm-2 mb-3"><img src="{{ getasset('/app-assets/img/sidebar-bg/04.jpg')}}" width="90" class="rounded sb-bg-04 {{ getSession('sidebar-background') == 'app-assets/img/sidebar-bg/04.jpg' ? 'selected' : '' }}"></div>
          <div class="col-sm-2 mb-3"><img src="{{ getasset('/app-assets/img/sidebar-bg/05.jpg')}}" width="90" class="rounded sb-bg-05 {{ getSession('sidebar-background') == 'app-assets/img/sidebar-bg/05.jpg' ? 'selected' : '' }}"></div>
          <div class="col-sm-2 mb-3"><img src="{{ getasset('/app-assets/img/sidebar-bg/06.jpg')}}" width="90" class="rounded sb-bg-06 {{ getSession('sidebar-background') == 'app-assets/img/sidebar-bg/06.jpg' ? 'selected' : '' }}"></div>
        </div>
        ...
        <div class="tl-bg-img d-none">
          ...
          <div class="cz-tl-bg-image row">
            <div class="col-sm-3"><img src="{{ getasset('/app-assets/img/gallery/bg-glass-1.jpg')}}" width="90" class="rounded bg-glass-1 {{ getSession('sidebar-background') == 'app-assets/img/gallery/bg-glass-1.jpg' ? 'selected' : '' }}"></div>
            <div class="col-sm-3"><img src="{{ getasset('/app-assets/img/gallery/bg-glass-2.jpg')}}" width="90" class="rounded bg-glass-2 {{ getSession('sidebar-background') == 'app-assets/img/gallery/bg-glass-2.jpg' ? 'selected' : '' }}"></div>
            <div class="col-sm-3"><img src="{{ getasset('/app-assets/img/gallery/bg-glass-3.jpg')}}" width="90" class="rounded bg-glass-3 {{ getSession('sidebar-background') == 'app-assets/img/gallery/bg-glass-3.jpg' ? 'selected' : '' }}"></div>
            <div class="col-sm-3"><img src="{{ getasset('/app-assets/img/gallery/bg-glass-4.jpg')}}" width="90" class="rounded bg-glass-4 {{ getSession('sidebar-background') == 'app-assets/img/gallery/bg-glass-4.jpg' ? 'selected' : '' }}"></div>
          </div>
        </div>
        <!-- Transparent BG Image Ends    -->
        <hr>
          ...
          <div class="switch"><span>Sidebar Bg Image</span>
            <div class="float-right">
              <div class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                <input id="sidebar-bg-img" type="checkbox" {{ getSession('sidebar-background') ? 'checked' : '' }}  class="custom-control-input cz-bg-image-display">
        ...
        <div class="togglebutton">
          <div class="switch"><span>Compact Menu</span>
            <div class="float-right">
              <div class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                <input id="cz-compact-menu" type="checkbox" {{ getSession('compact-menu') ? 'checked' : '' }} class="custom-control-input cz-compact-menu">
        ...
        <div>
          ...
          <select id="cz-sidebar-width" class="custom-select cz-sidebar-width float-right">
            <option {{ getSession('sidebar-width') == 'sidebar-sm' ? 'selected=""' : ''  }} value="small">Small</option>
            <option {{ getSession('sidebar-width') == '' ? 'selected=""' : ''  }} value="medium" >Medium</option>
            <option {{ getSession('sidebar-width') == 'sidebar-lg' ? 'selected=""' : ''  }} value="large">Large</option>
          </select>
        </div>
        <!-- Sidebar Width Ends-->
      </div>
