      ...
      <div id="navbarSupportedContent" class="collapse navbar-collapse">
        <ul class="navbar-nav">
          <li class="dropdown nav-item">
            <a id="siteHome" href="{{ route('site.home') }}" target="_blank" class="nav-link position-relative">
              <i class="ft-globe font-medium-3 blue-grey darken-4"></i>
              <p class="d-none">Home</p>
            </a>

          <li class="nav-item mr-2 d-none d-lg-block"><a data-toggle="modal" data-show="false" data-target="#media-manager" href="javascript:;" class="nav-link ">
            <i class="ft-image font-medium-3 blue-grey darken-4"></i>
              <p class="d-none">Media Manager</p>
            </a></li>
          <li class="nav-item mr-2 d-none d-lg-block"><a data-toggle="modal" data-show="false" data-target="#file-manager" href="javascript:;" class="nav-link "><i class="ft-folder font-medium-3 blue-grey darken-4"></i>
              <p class="d-none">File Manager</p>
            </a></li>
          ...
          <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-flag font-medium-3 blue-grey darken-4"></i><span class="selected-language d-none"></span></a>
            <div class="dropdown-menu dropdown-menu-right text-left">
              ...
              <a href="{{ route('admin.setlang',['lang'=> $lang->code ]) }}" class="dropdown-item py-1 {{ getSession('active_lang') == $lang->code ? 'active' : '' }} "><img src="{{ getasset('/app-assets/img/flags/'.$lang->img.'.png') }}" class="langimg" /><span> {{ $lang->title }}</span></a>
              @endforeach
          ...
          <li class="dropdown nav-item">
            <a id="dropdownBasic3" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"  class="nav-link position-relative "><i class="ft-power mr-2"></i>
