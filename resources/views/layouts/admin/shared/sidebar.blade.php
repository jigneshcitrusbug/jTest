...
<!--  
                ...
                <!-- <li class=" nav-item ">
                    <a href="{{ route('admin.seos') }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Seo</span> 
                    </a> 
                </li> -->

                <!-- <li class=" nav-item ">
                    <a href="{{ route('admin.settings.module',['module'=>'global']) }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Setting</span> 
                    </a> 
                </li> -->


                <!-- <li class=" nav-item active">
                    <a href="{{ route('admin.rolls') }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Rolls</span> 
                    </a> 
                </li>
                ...
                <li class=" nav-item active">
                    <a href="{{ route('admin.rollpermissions',['module'=>'global']) }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Roll Permissions</span> 
                    </a> 
                </li> -->
                ...
                <!-- <li class="has-sub nav-item">
                      <a href="#"><i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Dashboard</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span></a>
            ...
            <ul id="main-menu-navigation-superadmin" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                     
              @if(getSess('is_super_admin'))
                <li class=" nav-item  ">
                    <a href="{{ route('admin.permissions') }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Permissions</span> 
                    </a> 
                </li>
              @endif
            ...
            @if(getSess('is_super_admin'))
                <li class=" nav-item ">
                    <a href="{{ route('admin.menu') }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Admin Menu</span> 
                    </a> 
                </li>
              @endif
              ...
              @if(getSess('is_super_admin'))
                <li class=" nav-item  ">
                    <a href="{{ route('admin.generator') }}">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">Generator</span> 
                    </a> 
                </li>
              @endif
