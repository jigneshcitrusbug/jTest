...
@foreach($technologies as $key=>$item)
        ...
        @php 
            // $item->manyfile->where('file_type','technologies_single_main')->first()->file_thumb_url;
            $technologies_single_main =    $item->technologies_single_main->first();
        @endphp
    
    @if( $technologies_single_main)
          <div class="bg-ourtechnology tech_bg_{{$key+1}}" style="background-image: url({{ $technologies_single_main->file_thumb_url}});"></div>
    @else 
    <div class="bg-ourtechnology tech_bg_{{$key+1}}" style="background-image: url();"></div>
    @endif 
@endforeach
                ...
                <div class="col-lg-12">
                    <div class="our-technology-listing" itemprop="articleBody">
                        ...
                        <div class="technology-box">
                            <a href="{{ route('site.tech',['slug'=>$item->slug]) }}" class="tech_bg_{{$key+1}}" data-id="{{$key+1}}" >
                                {{ $item->title }}
                                <div class="hover-description">
                                    ...
                                    <span href="{{ route('site.tech',['slug'=>$item->slug]) }}" class="btn btn-learn-more">Learn More</span>
                                </div>
                            </a>
                        </div>
                        @endforeach
