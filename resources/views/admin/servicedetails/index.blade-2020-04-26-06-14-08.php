                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="actions pull-left">
                                        ...
                                        <a href="{{ route('admin.settings',['module'=>$context])  }}" class="btn btn-success btn-sm" title="Add New User">
                                            <i class="fa fa-plus" aria-hidden="true"></i> @lang('common.settings')
                                        </a>
