$(document).ready(function() {
  ...
  $(".cz-bg-color span").on("click", function() {
    ...
    updateSetting('bg-color', bgColor);
  ...
  $(".cz-bg-image img").on("click", function() {
    ...
    updateSetting('sidebar-background', src);
  ...
  $(".cz-bg-image-display").on("click", function() {
    ...
    if ($this.prop("checked") === true) {
      ...
      updateSetting('sidebar-background', '');
    }
  ...
  $(".cz-compact-menu").on("click", function() {
    ...
    updateSetting('compact-menu', $(this).prop("checked") === true ? '1' : '0');
  ...
  $(".cz-sidebar-width").on("change", function() {
    ...
    if (width_val === "small") {
      $(wrapper)
        ...
        .addClass("sidebar-sm");
        updateSetting('sidebar-width', "sidebar-sm");
    } else if (width_val === "large") {
      $(wrapper)
        .removeClass("sidebar-sm")
        .addClass("sidebar-lg");
        updateSetting('sidebar-width', "sidebar-lg");
    } else {
  ...
  $("#ll-switch").on("click", function() {
    ...
    updateSetting('theme-layout', 'light');
  ...
  $("#dl-switch").on("click", function() {
    ...
    updateSetting('theme-layout', 'dark');
  ...
  $("#tl-switch").on("click", function() {
    ...
    updateSetting('theme-layout', 'transparent');
  ...
  $(".customizer-content .bg-glass-1").on("click", function() {
    ...
    updateSetting('theme-transparent-bg', 'bg-glass-1');
...
function updateSetting(key, value){
  ...
  $.ajax({
    method: "POST", 
    url: "/admin/settings/storeAjax",
    data : {
      'key' : key,
      'value' : value,
      '_token' : $("#customizer_csrf_token").val()
    } 
  })
    .done(function( html ) {
      $( "#results" ).append( html );
